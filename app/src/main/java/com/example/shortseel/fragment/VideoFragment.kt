...
import com.example.shortseel.databinding.FragmentVideoBinding
import com.example.shortseel.model.Post
import com.example.shortseel.recyclerviewadapters.VideoScrollerAdapter
import com.example.shortseel.viewmodels.VideoListViewModel
import java.io.File

class VideoFragment : Fragment(R.layout.fragment_video) {
    private var videoFragmentBinding: FragmentVideoBinding? = null
    ...
    override fun onCreateView(
        ...
        videoFragmentBinding = FragmentVideoBinding.inflate(layoutInflater)
        return binding.root
    }
